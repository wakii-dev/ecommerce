...
## 4. CSS chiến lược
- `chrome/styles.css` (export `./styles.css`): `.chrome-header*`, `.chrome-icon-btn`, `.chrome-vh`, `.um-*`, `.site-footer*`, `.chrome-container` (1240px/padding 16 — P1 critic: footer self-contained, không phụ thuộc `.container` của storefront) (port values từ shell `header.css` + account `page.css` + storefront `app.css` tương ứng — CHỈ var(--*), không hex). Shell `main.tsx` import thêm `@ecommerce/chrome/styles.css` (touch map ✓).
